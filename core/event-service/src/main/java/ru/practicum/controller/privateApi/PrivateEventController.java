...
public class PrivateEventController {
    ...
    public List<EventShortDto> getEvents(
        ...
        log.info(
                "PRIVATE-API: Пользователь ID={} запрашивает список своих событий (from={}, size={})",
                userId, from, size
        );
    ...
    public List<ParticipationRequestDto> getEventParticipationRequests(
        ...
        log.info(
                "PRIVATE-API: Пользователь ID={} запрашивает заявки на участие для своего события ID={}",
                userId, eventId
        );
    ...
    public EventRequestStatusUpdateResult updateParticipationRequestStatus(
        ...
        log.info(
                "PRIVATE-API: Пользователь ID={} обновляет статусы заявок для события ID={}: {}",
                userId, eventId, requestStatusUpdateDto
        );
        return eventService.updateParticipationRequestStatus(userId, eventId, requestStatusUpdateDto);
    }
}
